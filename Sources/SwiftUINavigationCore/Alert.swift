  ...
  extension View {
    ...
    ///     state.
    @available(iOS 15, macOS 12, tvOS 15, watchOS 8, *)
    public func alert<Item, Actions: View, Message: View>(
      _ item: Binding<Item?>,
      title: (Item) -> Text,
    ...
    /// - Parameters:
    ///   - item: The item binding.
    ///   - title: The alert title builder.
    ///   - actions: The action builder.
    ///   - message: The message builder.
    /// - Returns: The resulting view.
    /// - SeeAlso: ``alert(_:title:actions:message:)``
    @available(iOS 15, macOS 12, tvOS 15, watchOS 8, *)
    public func alert<Item, Actions: View, Message: View>(
      _ item: Binding<Item?>,
