...
extension View {
  ...
  ///
  /// - Parameters:
  ///   - item: A binding to an optional source of truth for the inspector. When `item` is non-`nil`,
  ///     the system passes the item's content to the modifier's closure. You display this content
  ///     in an inspector that you create that the system displays to the user.
